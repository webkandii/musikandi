            ...
            try {
                ...
                if($count >= 1) { // Check email address is valid
                    ...
                    if($hash != $db_password) { // Check password 
                        ...
                        validate_user($db_id, $db_first_name, $db_last_name, $email, $db_permissions, $db_ab_count, $db_ab_agents, $db_ab_worldwide, $db_ab_promoters, $db_ab_digital, $db_ab_print, $db_ab_broadcast, $db_ab_venues, $db_ab_london, $db_ab_festivals, $db_ab_nonukfests, $db_ab_tech);
        ...
        <header <?php if(isset($page) && $page == 'home') { echo 'class="home"'; } ?>>
            <div class="container">
                ...
                <div class="bottom-home">
                    <h1>A free resource for bands, media and music professionals</h1>
                    
                    <p>This site is a series of lists. They're my contacts from when I worked full-time in music a few years back. Don't see it as an up to the minute database, but as a guide. Please don't spam people. They won't appreciate it. Use this site to start building your own lists of contacts. If you'd like to add to it or update entries, ask me for a login code.</p>
